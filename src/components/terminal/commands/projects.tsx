...
export const projectsCommand: CommandHandler = {
  ...
  execute: (args, data) => {
        ...
        return {
          output: (
            <div className="cmd-output">
              <span className="cmd-error">Unknown category "{args[0]}"</span>
              <div className="cmd-muted">Available: tool, proj, game</div>
            </div>
          ),
          isError: true,
        };
    ...
    return {
      output: (
        <div className="cmd-output">
          <div className="cmd-section-title">Projects</div>
          <div className="category-pills">
            <span className="cmd-muted">Filter: </span>
          ...
          {projs.map(p => (
            <div className="proj-card" key={p.name}>
              ...
              <div className="proj-tech">  Tech: {p.tech.join(', ')}</div>
